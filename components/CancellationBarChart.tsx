...
function CancellationReasons({
  ...
  // Total of ALL cancellation reasons.
  // This keeps percentages based on the actual cancellation total.
...
function CancellationOwners({
  ...
  return (
    <div
      className="grid grid-cols-1 items-center gap-3 xl:grid-cols-[1.05fr_0.95fr]"
